...
export const ProductCard: React.FC<ProductCardProps> = ({
  ...
  return (
    <motion.div 
      className="bg-white rounded-3xl border border-gold/15 overflow-hidden luxury-shadow flex flex-col h-full group"
      id={`product-card-${product.id}`}
      whileHover={{ 
        y: -6, 
        scale: 1.02,
        boxShadow: "0 20px 40px -15px rgba(10, 46, 32, 0.15), 0 15px 30px -10px rgba(212, 175, 55, 0.1)"
      }}
      transition={{ 
        type: "spring", 
        stiffness: 350, 
